...
3. Deployment: 
4. Done __.__.2026 / deadline 14.07.2026
5. Score: 550 / 550
...
- Feature 2: Sign In / Sign Up (50 points)
  ...
  - [x] Client-side validation is implemented (email format, password strength: min 8 chars, at least one letter, one digit, one special character, Unicode supported). [20 points]
...
- Feature 6: About Page (25 points)
  - [x] About page is accessible to all users (public route). [5 points]
  - [x] About page contains information about the RS School course. [5 points]
  - [x] About page contains team member information (names, roles, GitHub links). [10 points]
  - [x] About page design is consistent with the application design. [5 points]
- Feature 7: General Requirements (55 points)
  - [x] Multiple (at least 2) languages are supported with an i18n toggler in the header. [30 points]
  ...
  - [x] Private routes are properly protected (401 if not authenticated). See RFC 9110. [5 points]
- Feature 8: YouTube Video (50 points)
  - [x] A 5–7 minute YouTube video is linked in the pull request demonstrating all implemented features. [50 points]
